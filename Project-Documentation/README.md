...
| [CalEnviroScreen Comparison Analysis](CalEnviroScreen-Comparison-Analysis) | Comparison of Disadvantaged Community (DAC) designations between CalEnviroScreen 4.0 and Draft CalEnviroScreen 5.0, with a focus on changes in the Bay Area and alignment with MTC/ABAG Equity Priority Communities (EPCs). |
